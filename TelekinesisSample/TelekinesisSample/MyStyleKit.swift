...
//  Copyright © 2016 wodedata.com. All rights reserved.
//
...
public class MyStyleKit : NSObject {
    ...
    private struct Cache {
        static let color: UIColor = UIColor(red: 1.000, green: 0.008, blue: 0.008, alpha: 0.777)
    }
    ...
    public dynamic class func drawOvalCanvas(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), resizing: ResizingBehavior = .aspectFit, frame: CGRect = CGRect(x: 40, y: 40, width: 120, height: 120)) {
